...
- `workingDir` (String) Working directory of the program. If not supplied, the program will run in the current directory.
...
```
<!-- cache-key: cdktf-0.20.1 input-e08070c40220a33a70423305d0ab48388b2d87631e4ad3bec467084e40608ba5 -->